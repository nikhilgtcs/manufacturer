...
public class Component {
	...
	public Component(Integer componentId, @NotBlank @NotNull @Pattern(regexp = "^[A-Za-z]+$") String componentName,
			@NotBlank @NotNull String description, Set<Supplier> suppliers, Product product) {
		super();
